...
/**
 * Thread which is responsible for using the US sensor and the wall rammer to localize in the beginning of the
 * competition
 * 
 * @author yp
 *
...
public class UltrasonicLocalizer implements Runnable {
  ...
  /**
   * method for the initial state, the robot turns until the reading of higher than 5 tiles away is detected, at whcih
   * point we know that the robot is pointing away from the wall
   */
  ...
  /**
   * method for when the robot is pointing away from the wall, it continues to turn until it encounters a wall, at which
   * point it slows down
   */
  ...
  /**
   * the method for that the robot takes to detect the y-axis wall. the robot turns very slowly until there is an
   * increase to the reading, at which point we know that the robot is relatively perpendicular to the y-axis wall
   */
  ...
  /**
   * The robot is pointing towards to y-axis wall and drives forward for about 5 seconds, the two protruding rammers
   * will heklp the robot to align itself
   */
  ...
  /**
   * the robot drive forward for about 7.5 seconds to ram the x-axis wall. again the protruding rammers will help the
   * robot to align with x-wall
   */
  ...
  /**
   * the robot back up from the x-axis wall and turns clock-wise 180 degrees. After this statge the robot will be at the
   * center of the square and facing exactly 0 degrees
   */
