...
public class PathFinder {
   ...
   * A* stuff
   */
  private static PriorityQueue<Square> open = new PriorityQueue<Square>(20); // priority queue used to determine the
                                                                             // best path
  ...
  /**
   * this returns a list of int[] of size 2, which represents the list of moves the robot should make to get to the
   * target
   * 
   * @return
   */
  ...
  public static PathFinder test(int arenaSizeX, int arenaSizeY, int tunnelLLX, int tunnelLLY, int tunnelURX,
    ...
    PathFinder pf = new PathFinder(arenaSizeX, arenaSizeY, tunnelLLX, tunnelLLY, tunnelURX, tunnelURY, baseLLX, baseLLY,
        baseURX, baseURY, islandLLX, islandLLY, islandURX, islandURY);
